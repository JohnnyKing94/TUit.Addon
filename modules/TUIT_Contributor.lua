...
function TUIT_Contributors:CreateScene(TUIT_MENU_BAR)
	local TUIT_SCENE_CONTRIBUTOR = ZO_Scene:New("TUit_Contributor", SCENE_MANAGER)

	-- Assegnazione Background e "componenti" grafici da visualizzare
	-- TUIT_SCENE_CONTRIBUTOR:AddFragment(ZO_WindowSoundFragment:New(SOUNDS.BACKPACK_WINDOW_OPEN, SOUNDS.BACKPACK_WINDOW_CLOSE))
	TUIT_SCENE_CONTRIBUTOR:AddFragmentGroup(FRAGMENT_GROUP.MOUSE_DRIVEN_UI_WINDOW)
	TUIT_SCENE_CONTRIBUTOR:AddFragmentGroup(FRAGMENT_GROUP.PLAYER_PROGRESS_BAR_KEYBOARD_CURRENT)
	TUIT_SCENE_CONTRIBUTOR:AddFragment(TITLE_FRAGMENT)
	TUIT_SCENE_CONTRIBUTOR:AddFragment(RIGHT_BG_FRAGMENT)
	TUIT_SCENE_CONTRIBUTOR:AddFragment(TOP_BAR_FRAGMENT)
	...
	TUIT_SCENE_CONTRIBUTOR:AddFragment(TUIT_CONTRIBUTORI_TITLE_FRAGMENT)
	...
	TUIT_SCENE_CONTRIBUTOR:AddFragment(TUIT_CONTRIBUTORI_WINDOW)

	TUIT_SCENE_CONTRIBUTOR:AddFragment(TUIT_MENU_BAR)

    return TUIT_SCENE_CONTRIBUTOR
end
