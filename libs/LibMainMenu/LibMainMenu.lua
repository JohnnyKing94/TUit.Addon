...
function LibMainMenu:AddCategory(data)
	...
	--[[local menuBar = CreateControlFromVirtual("testBar1_print", GuiRoot, "testBar1")
	...
	local newControl = ZO_MenuBar_AddButton(menuBar, data1)]]--
